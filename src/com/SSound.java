...
public class SSound {
     ...
     * Play sound
     *
     * @param src     Sound filename
     * @param looping Looping
     */
    public static final void play(String src, boolean looping) {
        play(src, looping, 1f, 1f);
    }
     ...
     * @param src Sound filename
     */
    public static final void play(String src) {
        play(src, false, 1f, 1f);
    }
