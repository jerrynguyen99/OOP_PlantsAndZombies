...
public abstract class Sun implements Clickable {
    ...
    public void setFramePass(int framePass) {
        this.framePass = framePass;
    }

    public int getStayTimeInFrame() {
        return stayTimeInFrame;
    }

    public void setStayTimeInFrame(int stayTimeInFrame) {
        this.stayTimeInFrame = stayTimeInFrame;
    }
